 ...
 * 
 */
package com.dhxa.bizcloud.appservice.common.controller;
...
public class Response {
	...
	public String toMmGridJson( QuickPager<?> quickPager) {
		if (this.data == null) {
			this.data = new HashMap<String, Object>(2);
		}
		if (!this.data.containsKey(resCodeKey)) {
		...
		this.data.put("totalCount", quickPager.getTotalRows());// 当前页码
		this.data.put("items", (quickPager.getData() == null ? new ArrayList<Object>(0) : quickPager.getData()));
	...
	public String toMmGridJson( List<?> list) {
		if (this.data == null) {
			this.data = new HashMap<String, Object>(2);
		}
		if (!this.data.containsKey(resCodeKey)) {
		...
		this.data.put("totalCount", list.size());
		this.data.put("items", (list == null ? new ArrayList<Object>(0) : list));
